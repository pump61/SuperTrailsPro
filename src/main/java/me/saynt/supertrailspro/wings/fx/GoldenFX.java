...
public class GoldenFX extends WingsPostFX {
   public GoldenFX(String var1) {
      super(var1);
   }

   public void getPixel(TrailWings var1, ParticleEffect.OrdinaryColor var2, int var3, int var4) {
      if (Task.rainbowticks == var4) {
         var1.color = new ParticleEffect.OrdinaryColor(255, 215, 10);
      }
   }

   public void getPixel(TrailWings var1, WingsPattern var2, ParticleEffect.OrdinaryColor var3, int var4, int var5) {
      if (Task.rainbowticks == var5) {
         var2.color = new ParticleEffect.OrdinaryColor(255, 215, 10);
      }
   }
