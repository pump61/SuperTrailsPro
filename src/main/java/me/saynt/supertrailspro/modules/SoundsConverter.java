...
public enum SoundsConverter {
   ...
   private String IfTheyWillChangeSoundNamesOnceAgainIWillStartSpammingThemWithEmailsEveryFuckingSingleDayWhatABitches;

   private SoundsConverter(String var3, String var4) {
      this.oldSound = var3;
      this.newSound = var4;
   }

   private SoundsConverter(String var3, String var4, String var5) {
      this.oldSound = var3;
      this.newSound = var4;
      this.IfTheyWillChangeSoundNamesOnceAgainIWillStartSpammingThemWithEmailsEveryFuckingSingleDayWhatABitches = var5;
   }

   public static SoundsConverter get(String var0) {
      var0 = var0.toUpperCase();
      SoundsConverter[] var4;
      int var3 = (var4 = values()).length;

      for(int var2 = 0; var2 < var3; ++var2) {
         SoundsConverter var1 = var4[var2];
         if (var1.newSound.equalsIgnoreCase(var0) || var1.oldSound.equalsIgnoreCase(var0)) {
            return var1;
         }
      }
   ...
   public Sound toSound() {
      if (this == ERROR) {
         return null;
      } else if (SuperTrails.currentversion == ServerVersionsEnum.S18) {
         return Sound.valueOf(this.oldSound);
      } else {
         return ServerVersion.higherThanOrEqual(ServerVersionsEnum.S113) && this.IfTheyWillChangeSoundNamesOnceAgainIWillStartSpammingThemWithEmailsEveryFuckingSingleDayWhatABitches != null ? Sound.valueOf(this.IfTheyWillChangeSoundNamesOnceAgainIWillStartSpammingThemWithEmailsEveryFuckingSingleDayWhatABitches) : Sound.valueOf(this.newSound);
      }
   }
}
