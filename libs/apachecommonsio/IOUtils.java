...
import libs.apachecommonsio.output.ByteArrayOutputStream;
import libs.apachecommonsio.output.StringBuilderWriter;
...
public class IOUtils {
   ...
   public static byte[] toByteArray(InputStream var0, int var1) {
      if (var1 < 0) {
         ...
         int var2;
         int var3;
         for(var3 = 0; var3 < var1 && (var2 = var0.read(var4, var3, var1 - var3)) != -1; var3 += var2) {
         }
   ...
   public static String toString(URL var0, Charset var1) {
      ...
      String var5;
      try {
         String var3 = toString(var2, var1);
         var5 = var3;
      } finally {
         var2.close();
      }
   ...
   public static void write(StringBuffer var0, OutputStream var1) {
      write((StringBuffer)var0, (OutputStream)var1, (String)null);
   }
   ...
   public static void writeLines(Collection<?> var0, String var1, OutputStream var2, Charset var3) {
      if (var0 != null) {
         ...
         for(Iterator var6 = var0.iterator(); var6.hasNext(); var2.write(var1.getBytes(var4))) {
            Object var5 = var6.next();
            if (var5 != null) {
               var2.write(var5.toString().getBytes(var4));
            }
         }
   ...
   public static void writeLines(Collection<?> var0, String var1, Writer var2) {
      if (var0 != null) {
         ...
         for(Iterator var4 = var0.iterator(); var4.hasNext(); var2.write(var1)) {
   ...
   public static long copyLarge(InputStream var0, OutputStream var1, long var2, long var4, byte[] var6) {
      ...
      if (var4 == 0L) {
         ...
         int var8;
         int var9 = var8 = var6.length;
         if (var4 > 0L && var4 < (long)var8) {
            var9 = (int)var4;
         }
         ...
         int var7;
         while(var9 > 0 && -1 != (var7 = var0.read(var6, 0, var9))) {
            var1.write(var6, 0, var7);
            var10 += (long)var7;
            if (var4 > 0L) {
               var9 = (int)Math.min(var4 - var10, (long)var8);
            }
         }
   ...
   public static long copyLarge(Reader var0, Writer var1, long var2, long var4, char[] var6) {
      ...
      if (var4 == 0L) {
         ...
         int var7;
         while(var8 > 0 && -1 != (var7 = var0.read(var6, 0, var8))) {
            var1.write(var6, 0, var7);
            var9 += (long)var7;
            if (var4 > 0L) {
               var8 = (int)Math.min(var4 - var9, (long)var6.length);
            }
         }
   ...
   public static boolean contentEquals(InputStream var0, InputStream var1) {
      ...
      int var2;
      for(int var3 = ((InputStream)var0).read(); -1 != var3; var3 = ((InputStream)var0).read()) {
         var2 = ((InputStream)var1).read();
         if (var3 != var2) {
            return false;
         }
      }
   ...
   public static boolean contentEquals(Reader var0, Reader var1) {
      ...
      int var2;
      for(int var3 = var4.read(); -1 != var3; var3 = var4.read()) {
         var2 = var5.read();
         if (var3 != var2) {
            return false;
         }
   ...
   public static long skip(InputStream var0, long var1) {
      if (var1 < 0L) {
         ...
         long var3;
         long var5;
         for(var3 = var1; var3 > 0L && (var5 = (long)var0.read(SKIP_BYTE_BUFFER, 0, (int)Math.min(var3, 2048L))) >= 0L; var3 -= var5) {
         }
   ...
   public static long skip(Reader var0, long var1) {
      if (var1 < 0L) {
         ...
         long var3;
         long var5;
         for(var3 = var1; var3 > 0L && (var5 = (long)var0.read(SKIP_CHAR_BUFFER, 0, (int)Math.min(var3, 2048L))) >= 0L; var3 -= var5) {
         }
   ...
   public static int read(Reader var0, char[] var1, int var2, int var3) {
      if (var3 < 0) {
         ...
         int var4;
         int var5;
         for(var4 = var3; var4 > 0 && -1 != (var5 = var0.read(var1, var2 + (var3 - var4), var4)); var4 -= var5) {
         }
