   ...
   private static String doNormalize(String var0, char var1, boolean var2) {
      if (var0 == null) {
         ...
         if (var4 == 0) {
            ...
            int var5 = getPrefixLength(var0);
            if (var5 < 0) {
               return null;
            } else {
               char[] var6 = new char[var4 + 2];
               var0.getChars(0, var0.length(), var6, 0);
               char var7 = var1 == SYSTEM_SEPARATOR ? OTHER_SEPARATOR : SYSTEM_SEPARATOR;
               ...
               for(var3 = var5 + 1; var3 < var4; ++var3) {
                  if (var6[var3] == var1 && var6[var3 - 1] == var1) {
                     System.arraycopy(var6, var3, var6, var3 - 1, var4 - var3);
                     --var4;
                     --var3;
                  }
               }
               ...
               for(var3 = var5 + 1; var3 < var4; ++var3) {
                  if (var6[var3] == var1 && var6[var3 - 1] == '.' && (var3 == var5 + 1 || var6[var3 - 2] == var1)) {
                     if (var3 == var4 - 1) {
                        var10 = true;
                     }

                     System.arraycopy(var6, var3 + 1, var6, var3 - 1, var4 - var3);
                     var4 -= 2;
                     --var3;
                  }
               }
               ...
               label116:
               for(var3 = var5 + 2; var3 < var4; ++var3) {
                  if (var6[var3] == var1 && var6[var3 - 1] == '.' && var6[var3 - 2] == '.' && (var3 == var5 + 2 || var6[var3 - 3] == var1)) {
                     if (var3 == var5 + 2) {
                        return null;
                     }
                     ...
                     for(int var9 = var3 - 4; var9 >= var5; --var9) {
                        if (var6[var9] == var1) {
                           System.arraycopy(var6, var3 + 1, var6, var9 + 1, var4 - var3);
                           var4 -= var3 - var9;
                           var3 = var9 + 1;
                           continue label116;
                        }
                     ...
                     System.arraycopy(var6, var3 + 1, var6, var5, var4 - var3);
                     var4 -= var3 + 1 - var5;
                     var3 = var5 + 1;
                  }
               }
               ...
               if (var4 <= 0) {
                  ...
                  return new String(var6, 0, var4);
               } else if (var10 && var2) {
                  return new String(var6, 0, var4);
               } else {
                  return new String(var6, 0, var4 - 1);
               }
            }
         }
      }
         ...
         if (var1 == 0) {
            ...
            if (var2 == ':') {
               ...
               if (var2 == '~') {
                  ...
                  if (var3 == ':') {
                     if ((var2 = Character.toUpperCase(var2)) >= 'A' && var2 <= 'Z') {
         ...
         do {
            ...
            for(; var6 < var3.length; ++var6) {
               if (var3[var6].equals("?")) {
                  ...
                  if (var4) {
                     if ((var5 = var2.checkIndexOf(var0, var5, var3[var6])) == -1) {
                        break;
                     }
