...
public class ByteArrayOutputStream extends OutputStream {
   ...
   public void write(byte[] var1, int var2, int var3) {
      if (var2 >= 0 && var2 <= var1.length && var3 >= 0 && var2 + var3 <= var1.length && var2 + var3 >= 0) {
         if (var3 != 0) {
            synchronized(this) {
               int var6 = this.count + var3;
               int var7 = var3;
               int var8 = this.count - this.filledBufferSum;

               while(var7 > 0) {
                  int var9 = Math.min(var7, this.currentBuffer.length - var8);
                  System.arraycopy(var1, var2 + var3 - var7, this.currentBuffer, var8, var9);
                  if ((var7 -= var9) > 0) {
   ...
   public synchronized int write(InputStream var1) {
      ...
      for(int var4 = var1.read(this.currentBuffer, var3, this.currentBuffer.length - var3); var4 != -1; var4 = var1.read(this.currentBuffer, var3, this.currentBuffer.length - var3)) {
         var2 += var4;
         this.count += var4;
         if ((var3 += var4) == this.currentBuffer.length) {
   ...
   public synchronized void writeTo(OutputStream var1) {
      ...
      while(var4.hasNext()) {
         byte[] var3 = (byte[])var4.next();
         int var5 = Math.min(var3.length, var2);
   ...
   private InputStream toBufferedInputStream() {
      ...
      if (var1 == 0) {
         ...
         while(var4.hasNext()) {
            byte[] var3 = (byte[])var4.next();
            int var5 = Math.min(var3.length, var1);
            var2.add(new ByteArrayInputStream(var3, 0, var5));
            if ((var1 -= var5) == 0) {
               break;
            }
         }
   ...
   public synchronized byte[] toByteArray() {
      ...
      if (var1 == 0) {
         ...
         while(var5.hasNext()) {
            byte[] var4 = (byte[])var5.next();
            int var6 = Math.min(var4.length, var1);
            System.arraycopy(var4, 0, var2, var3, var6);
            var3 += var6;
            if ((var1 -= var6) == 0) {
               break;
            }
